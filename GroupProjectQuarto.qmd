...
These predictive checks involved simulating data and then plotting it like normal. Then we created a side-by-side comparison using the [patchwork package](https://github.com/thomasp85/patchwork).
