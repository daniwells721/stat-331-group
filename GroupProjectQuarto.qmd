...
Our cleaned data sets are seperated by country and year with each row being a the specific life expectancy and CO2 emissions for that country in that year. We decided to look at at a century's worth of data from the years 1920 - 2020. Countries with NAs for values within these years were removed.
