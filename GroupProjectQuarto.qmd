...
From this graph we observe that most country's CO2 emissions and life expectancy at birth have increased. We also see that life expectancy tends to start plateauing around the 80-85 year range, while CO2 emissions continue to grow exponentially for some countries. We can also see that there is not a strong relationship between life expectancy and CO2 emissions as there is not one strict line that we observe in the scatter plot. However if we were to classify a possible relationship between life expectancy and C02 emissions based on these graphs then it would be a weak positive correlation with numerous outliers that seem to follow the trend of exponential growth of CO2.  
...
Based on this scatter plot we again observe that the relationship between life expectancy and CO2 emissions is very weak. However our linear regression shows a positive correlation between life expectancy and CO2 emissions, this is likely due to the extreme outliers in our data. As we can see from the data table both China and the united states have extremely high levels of average CO2 emissions and average life expectancy which would bias our estimate of the relationship between average life expectancy and average CO2 emissions.
...
From our linear regression of average life expectancy on average CO2 emissions we get the equation: $\widehat {AvgLifeExpectancy} = 56.41 + 0.01(AvgEmissions)$

Based on this equation, the predicted average life expectancy of someone living in a country with no CO2 emissions would be approximately 56.41 years. Additionally, for each additional million tonne increase in average CO2 emissions per capita, predicted average life expectancy increases by 0.01 years.
