...
<<<<<<< HEAD
  scale_color_viridis_d(name = "Period", guide = guide_legend(title = "Two-Decade Period")) # Use Viridis color scale for clarity
=======
  scale_color_viridis_d(name = "Period", guide = guide_legend(title = "Two-Decade Period"))

>>>>>>> a99dfc4e4bfff55afb6e10bf0594f572f27eb4b3
```
