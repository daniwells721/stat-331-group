...
From this graph we observe that most country's CO2 emissions and life expectancy at birth have increased. We also see that life expectancy tends to start plateauing around the 80-85 year range, while CO2 emissions continue to grow exponentially for some countries.
...
datatable(tidy_co2life,  class = 'cell-border stripe hover',
          colnames = c("Coefficient Estimate" = "estimate", 
                       ...
                       "P-Value" = "p.value"),
          caption = "Table 1: Estimated Coefficients of the Linear Regression of Average Life Expectancy on Average Emissions",
)
```

From this regression we got the equation: $\widehat {AvgLifeExpectancy} = 56.41 + 0.01(AvgEmissions)$
...
datatable(modfit_table,  class = 'cell-border stripe hover',
          ...
          caption = "Table 2: Table of Varainces in our model to measure the fit of our model to the data.",
)
```
